...
class CezarFunctions:
    ...
    def calculateLettersProbability(text: str) -> float:
        ...
        polishLettersProbabilities = [0.099, 0.0147, 0.0436, 0.0325, 0.0877, 0.003, 0.0142, 0.0108, 0.0821, 
                                       0.0228, 0.0351, 0.0392, 0.028, 0.0572, 0.086, 0.0313, 0.0014,
                                       0.0469, 0.0498, 0.0398, 0.0250, 0.004, 0.0465, 0.005, 0.0376, 0.0089]
        score = 0
        for letter in text:
